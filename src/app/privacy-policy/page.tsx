    ...
    return (
        <div className="container mx-auto px-4 py-16 max-w-3xl">
            ...
            <div className="prose prose-invert max-w-none">
                ...
                <h2 className="text-xl font-bold text-white mt-6 mb-3">1. Collection of Personal Data</h2>
                <p className="mb-4">
                ...
                <h2 className="text-xl font-bold text-white mt-6 mb-3">2. Purpose of Processing</h2>
                <p className="mb-4">
                ...
                <h2 className="text-xl font-bold text-white mt-6 mb-3">3. Disclosure to Third Parties</h2>
                <p className="mb-4">
                ...
                <h2 className="text-xl font-bold text-white mt-6 mb-3">4. Security</h2>
                <p className="mb-4">
