        ...
        <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-200">
            <div className="container mx-auto px-4 h-16 flex items-center justify-between">
                <Link href="/" className="text-xl font-bold text-slate-800 tracking-tight">
                    PEK LAJU <span className="text-cyan-600">TRADING</span>
                </Link>

                <div className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-600">
                    <Link href="/" className="hover:text-cyan-600 transition-colors">产品目录</Link>
                    <Link href="/about" className="hover:text-cyan-600 transition-colors">关于我们</Link>
